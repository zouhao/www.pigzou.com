(function ($, window, document, undefined) {
    ...
    $(function () {
        ...
        $("#video_element").wallpaper({
                source: "images/wallpaper-277997.jpg"
        });
        ...
        $(document).on('submit', 'form#contact_form', function (e) {
            ...
            $('.requiredField').each(function () {
                ...
                if ($.trim($(this).val()) == '') {
                    ...
                    $(this).parent().append('<span class="error">请正确填写指定内容</span>');
                    ...
                    if (!emailReg.test($.trim($(this).val()))) {
						...
						$(this).parent().append('<span class="error">邮箱格式输入错误，请重新输入</span>');
            ...
            if (!hasError) {
                ...
                $.post($(this).attr('action'), formInput, function (data) {
					if(data=='Error1'){
						var labelText = $("#code").prev('label').text();
						$("#code").parent().append('<span class="error">验证码错误</span>');
						...
						$('form#contact_form').slideUp("fast", function () {
							$(this).before('<p class="success">Thank you!您提交的内容我已收到，我会尽快通过E-mail回复您！</p>');
						});
					}
